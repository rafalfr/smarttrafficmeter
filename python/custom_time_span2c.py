...
file = codecs.open("custom_time_span.js", "rb", "utf-8")
file_content = file.read()
file.close()

# save the gzip compressed file 
with gzip.open('custom_time_span.gz', 'wb', 9) as f:
    f.write(file_content)

# open the gzip compressed file
file = codecs.open("custom_time_span.gz", "rb")
...
file = codecs.open("custom_time_span.cpp", "w", "utf-8")

file.write("#include \"Resources.h\"\r\n")
file.write("\r\n")
file.write("uint32_t Resources::custom_time_span_js_length=")
file.write(str(chartjs_length)+";\r\n")
file.write("\r\n")
file.write("uint8_t Resources::custom_time_span_js[]=\r\n")
file.write("{")
file.write("\r\n")
