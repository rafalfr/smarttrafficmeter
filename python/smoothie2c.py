...
# https://raw.githubusercontent.com/joewalnes/smoothie/master/smoothie.js

# open the original file
file = codecs.open("smoothie.js", "rb", "utf-8")
file_content = file.read()
file.close()

# save the gzip compressed file 
with gzip.open('smoothie.js.gz', 'wb', 9) as f:
    f.write(file_content)

# open the gzip compressed file
file = codecs.open("smoothie.js.gz", "rb")
...
file = codecs.open("smoothiejs.cpp", "w", "utf-8")

file.write("#include \"Resources.h\"\r\n")
file.write("\r\n")
file.write("uint32_t Resources::smoothie_js_length=")
file.write(str(chartjs_length)+";\r\n")
file.write("\r\n")
file.write("uint8_t Resources::smoothie_js[]=\r\n")
file.write("{")
file.write("\r\n")
