...
with gzip.open('chartjs-plugin-zoom.min.js.gz', 'wb', 9) as f:
    f.write(file_content)

# open the gzip compressed file
file = codecs.open("chartjs-plugin-zoom.min.js.gz", "rb")
...
file = codecs.open("zoom.cpp", "w", "utf-8")

file.write("#include \"Resources.h\"\r\n")
file.write("\r\n")
file.write("uint32_t Resources::zoom_js_length=")
file.write(str(chartjs_length)+";\r\n")
file.write("\r\n")
file.write("uint8_t Resources::zoom_js[]=\r\n")
file.write("{")
file.write("\r\n")
