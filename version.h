...
namespace AutoVersion{
	...
	static const long REVISION  = 6989;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 1262;
	#define RC_FILEVERSION 2,1,1247,6989
	#define RC_FILEVERSION_STRING "2, 1, 1247, 6989\0"
	static const char FULLVERSION_STRING [] = "2.1.1247.6989";
